...
function NavExpandableList(props) {
    ...
    var _c = react_1.useState(((_a = window === null || window === void 0 ? void 0 : window.localStorage) === null || _a === void 0 ? void 0 : _a.getItem('isInfrastructureOpen')) !== 'false'), infrastructureIsOpen = _c[0], setInfrastructureOpen = _c[1];
    react_1.useEffect(function () {
        var _a;
        if (((_a = window === null || window === void 0 ? void 0 : window.localStorage) === null || _a === void 0 ? void 0 : _a.getItem('isInfrastructureOpen')) !== 'false') {
    ...
    return (react_1.default.createElement(react_core_1.Nav, { onSelect: function () { var _a; return (_a = props.postClick) === null || _a === void 0 ? void 0 : _a.call(props); } },
        react_1.default.createElement("div", { className: "oc-nav-header", style: { padding: 'var(--pf-global--spacer--sm) var(--pf-global--spacer--sm)' }, hidden: !switcherExists },
            react_1.default.createElement(react_core_1.Dropdown, { toggle: react_1.default.createElement(react_core_1.DropdownToggle, { id: "toggle-perspective", onToggle: function () { return setSwitcherOpen(!switcherIsOpen); }, toggleIndicator: react_icons_1.CaretDownIcon, style: { color: 'white' }, className: classes.perspective },
                    ...
                    react_1.default.createElement(react_core_1.DropdownItem, { onClick: function () { var _a; setSwitcherOpen(false); (_a = window === null || window === void 0 ? void 0 : window.localStorage) === null || _a === void 0 ? void 0 : _a.setItem('isInfrastructureOpen', 'false'); setInfrastructureOpen(false); }, key: 'acm' },
                        react_1.default.createElement(react_core_1.Title, { headingLevel: "h2", size: "md" },
                            react_1.default.createElement("span", { className: "oc-nav-header__icon" },
                                react_1.default.createElement(ACMIcon, null)),
                            react_1.default.createElement("span", { style: textStyles }, "Federated Management"))),
                    react_1.default.createElement(react_core_1.DropdownItem, { onClick: function () { var _a; setSwitcherOpen(false); (_a = window === null || window === void 0 ? void 0 : window.localStorage) === null || _a === void 0 ? void 0 : _a.setItem('isInfrastructureOpen', 'true'); setInfrastructureOpen(true); }, key: 'acm-inf' },
                        react_1.default.createElement(react_core_1.Title, { headingLevel: "h2", size: "md" },
                            react_1.default.createElement("span", { className: "oc-nav-header__icon" },
                                react_1.default.createElement(ACMIcon, null)),
                            react_1.default.createElement("span", { style: textStyles }, "Infrastructure Management"))),
        ...
        react_1.default.createElement(react_core_1.NavList, { className: classes.list },
            ...
            react_1.default.createElement(react_core_1.NavExpandable, { title: "Infrastructure", isActive: route === HubOfHubsRoute.Clusters ||
                ...
                react_1.default.createElement(react_core_1.NavItem, { isActive: route !== HubOfHubsRoute.Clusters && route !== HubOfHubsRoute.Credentials && route !== HubOfHubsRoute.Governance && route !== HubOfHubsRoute.Welcome, to: HubOfHubsRoute.HubClusters }, isConsoleRoute ? react_1.default.createElement(react_router_dom_1.Link, { to: HubOfHubsRoute.HubClusters }, "Hub Clusters") : 'Hub Clusters')
                :
